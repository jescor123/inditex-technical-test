...
public class QuestionServiceImpl implements QuestionService {
    ...
    public QuestionServiceImpl(QuestionRepository questionRepository, ComboBoxOptionServiceImpl comboBoxOptionService) {
    ...
    public Mono<ResponsePostDTO> saveQuestion(QuestionDTO questionDTO) {
        ...
        try {
            ...
            if (questionDTO.getComboBoxOptionDTOSet() != null) {
